    ...
    return (
        <>
            ...
            <div className="space-y-4">
                ...
                <p>Dóra Nagy - Architektin, Meeret Hoffmann - Planerin, Natalia Simonarson - Planerin<br/>
                    c/o Studiofreunde<br/>
                ...
                <p><strong>Kontakt:</strong> <br/>
                    Telefon: +49 157 85 91 84 35<br/>
                    E-Mail: <a href="mailto:info@studiofreunde.de">info@studiofreunde.de</a><br/></p>
                <p><strong>Berufsbezeichnung:</strong><br/>
                    Architektin<br/>
                    Verliehen durch: Bundesrepublik Deutschland<br/>
                    Zuständige Kammer: Bayrische Architektenkammer (BayAK)<br/>
                    Listennummer: 194134
                </p>
                <p><strong>Verbraucherstreitbeilegung / Universalschlichtungsstelle</strong>
                    <br/>Wir nehmen nicht an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle
                ...
                <p><strong>Haftungsausschluss: </strong>
                    ...
                    § 7
                    Abs.1 DDG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach §§
                    8 bis
